                        ...
                        <div class="col-lg-3  col-md-6 col-sm-6">
                            <div class="single-footer-widget mail-chimp">
                                ...
                                <ul class="instafeed d-flex flex-wrap">
                                    <li><img src="/client/imgi1.jpg" alt=""></li>
                                    <li><img src="/client/imgi2.jpg" alt=""></li>
                                    <li><img src="/client/imgi3.jpg" alt=""></li>
                                    <li><img src="/client/imgi4.jpg" alt=""></li>
                                    <li><img src="/client/imgi5.jpg" alt=""></li>
                                    <li><img src="/client/imgi6.jpg" alt=""></li>
                                    <li><img src="/client/imgi7.jpg" alt=""></li>
                                    <li><img src="/client/imgi8.jpg" alt=""></li>
                                </ul>
                            </div>
                        </div>
