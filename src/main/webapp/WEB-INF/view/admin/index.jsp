          ...
          <div class="container-lg">
            <div class="row justify-content-evenly">
              ...
              <div class="col d-none d-md-block">
                <p class="text-center text-black m-0"><strong>Special Offer</strong>: Free Shipping on all the orders
                  above $100
                </p>
              </div>
              <div class="col">
        ...
        <div class="container-lg">
          ...
          <div class="row">
            ...
            <div class="col-md-6 text-lg-end">
              <p>Free HTML by <a href="https://templatesjungle.com/" target="_blank">TemplatesJungle</a><br> Distributed
