  ...
  <%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
    ...
    <body class="g-sidenav-show  bg-gray-200">
      <aside
        ...
        id="sidenav-main">
        <% request.setAttribute("pageTitle", "Tables" ); %>
                      ...
                      <tbody>
                        <tr>
                          <td>
                            <div class="d-flex px-2 py-1">
                              <div>
                                <img src="/admin/img/team-2.jpg" class="avatar avatar-sm me-3 border-radius-lg"
                                  alt="user1">
                              </div>
                        ...
                        <tr>
                          <td>
                            <div class="d-flex px-2 py-1">
                              <div>
                                <img src="/admin/img/team-3.jpg" class="avatar avatar-sm me-3 border-radius-lg"
                                  alt="user2">
                              </div>
                              <div class="d-flex flex-column justify-content-center">
                        ...
                        <tr>
                          <td>
                            <div class="d-flex px-2 py-1">
                              <div>
                                <img src="/admin/img/team-4.jpg" class="avatar avatar-sm me-3 border-radius-lg"
                                  alt="user3">
                              </div>
                              <div class="d-flex flex-column justify-content-center">
                    ...
                    <table class="table align-items-center justify-content-center mb-0">
                      <thead>
                        <tr>
                          ...
                          <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">Budget
                          </th>
                      ...
                      <tbody>
                        <tr>
                          <td>
                            <div class="d-flex px-2">
                              <div>
                                <img src="/admin/img/small-logos/logo-asana.svg"
                        ...
                        <tr>
                          <td>
                            <div class="d-flex px-2">
                              <div>
                                <img src="/admin/img/small-logos/github.svg"
                        ...
                        <tr>
                          <td>
                            <div class="d-flex px-2">
                              <div>
                                <img src="/admin/img/small-logos/bootstrap.svg"
                        ...
                        <tr>
                          <td>
                            <div class="d-flex px-2">
                              <div>
                                <img src="/admin/img/small-logos/devto.svg" class="avatar avatar-sm rounded-circle me-2"
                                  alt="xd">
                              </div>
                              <div class="my-auto">
